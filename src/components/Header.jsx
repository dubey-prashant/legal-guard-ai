...
export const Header = ({ apiKey, setApiKey }) => {
  ...
  return (
    <header className='bg-white/90 backdrop-blur-lg shadow-soft border-b border-gray-200/50 sticky top-0 z-50'>
        ...
        <div className='flex items-center space-x-4'>
          <div className='flex items-center space-x-3'>
            <div className='relative'>
              ...
              <div className='relative bg-gradient-to-r from-primary-500 to-primary-600 p-2 rounded-xl'>
                <Shield className='h-6 w-6 text-white' />
              </div>
            </div>
            <div>
              <h1 className='text-2xl font-bold font-heading bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent'>
                LegalGuard AI
              </h1>
      ...
      {/* Settings Panel */}
      {isSettingsOpen && (
        <div className='absolute top-full right-4 mt-2 w-96 bg-white rounded-2xl shadow-large border border-gray-200 p-6 z-50 animate-slide-up'>
            ...
            <div>
              ...
              <div className='relative'>
                <input
                  ...
                  className='w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 pr-12 transition-all duration-200'
                />
                <button
                  type='button'
