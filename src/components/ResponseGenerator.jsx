...
export const ResponseGenerator = ({ analysis, apiKey, originalText }) => {
  ...
  const handleDownload = () => {
    ...
    a.href = url;
    a.download = `legal_response_${responseType}_${
        ...
        <div className='flex items-center space-x-3 mb-6'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-500'>
              AI-powered legal response drafting
            </p>
          </div>
        </div>
            ...
            <div className='flex items-start space-x-3'>
              ...
              <div>
                ...
                <p className='text-sm text-primary-800'>
                  ...
                  response is recommended based on our analysis. You can
                  customize the approach below.
                </p>
              </div>
            </div>
          </div>
          ...
          {isGenerating ? (
            <div className='text-center py-12'>
              ...
              <p className='text-gray-600 mb-4'>
                AI is generating a professional, legally sound response...
              </p>
              <div className='flex justify-center space-x-4 text-sm text-gray-500'>
                ...
                <span className='flex items-center space-x-1'>
                  <div
                    className='w-2 h-2 bg-success-600 rounded-full animate-bounce'
            ...
            <div className='space-y-4'>
              ...
              <div className='flex flex-wrap gap-2 mb-4'>
                <span className='status-info text-xs'>
                  Response Type:{' '}
                  {responseType?.replace('_', ' ')?.charAt(0).toUpperCase() +
                    responseType?.replace('_', ' ')?.slice(1)}
                </span>
                <span className='status-info text-xs'>
                ...
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <ul className='text-xs text-primary-800 space-y-1'>
                      <li>
                        • Review all dates, names, and legal references for
                        accuracy
                      </li>
                      <li>
                        • Customize the response to match your
                        organization&apos;s tone
                      </li>
                      <li>
                        • Consider having a legal professional review before
                        sending
                      </li>
                      <li>
